...
ax.scatter(x_ravel[:, 0], x_ravel[:, 1], rates_grid[x_num,12, :,:])
ax.set_xlabel("2s Lambda")
ax.set_ylabel("2p Lambda")
...
ax.scatter(x_ravel[:, 0], x_ravel[:, 1], rates_grid[z_num,12, :,:])
ax.set_xlabel("2s Lambda")
ax.set_ylabel("2p Lambda")
...
ax.scatter(x_ravel[:, 0], x_ravel[:, 1], rates_grid[w_num,12, :,:])
ax.set_xlabel("2s Lambda")
ax.set_ylabel("2p Lambda")
