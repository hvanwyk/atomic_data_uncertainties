C N. R. BADNELL     PROGRAM ADASDR       NRB v3.12              17/05/21
C
C***********************************************************************
C
...
C
 ...
 1000 FORMAT(20A4)
 1001 FORMAT(1X,50('-'),'ADASDR',50('-')//1X,20A4//1X,50('-'),'(V3.12)'
     X,50('-')//)
...
C
     ...
     X,ENERG(NDIM13) !STRICTLY, ONLY JK NEED BE NDIM10, ELSE NDIM13
...
C
      ...
      NV00=NV
      LV00=LV0-1
C      NMN=MAX(NV,NMN0)              !AS NO BUNDLE-NL NMN, ONLY BUNDLE-N
      IF(LV.GE.0)THEN
...
C
      IF(NCMX0.GT.IBN(IBX).AND.INIT.EQ.0)THEN         !NRSLMX
